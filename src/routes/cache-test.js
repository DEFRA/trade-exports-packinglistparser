...
import { getIsoCodesCache } from '../services/cache/iso-codes-cache.js'
import { STATUS_CODES } from './statuscodes.js'

const cacheTestIneligibleItems = {
  method: 'GET',
  path: '/cache/ineligible-items',
  handler: getIneligibleItemsCacheHandler
}

const cacheTestIsoCodes = {
  method: 'GET',
  path: '/cache/iso-codes',
  handler: getIsoCodesCacheHandler
}
 ...
 */
function getIneligibleItemsCacheHandler(_request, h) {
...
/**
 * Handler for testing ISO codes cache
 * @param {Object} _request - Hapi request object (unused)
 * @param {Object} h - Hapi response toolkit
 * @returns {Object} Response with cache status and data
 */
function getIsoCodesCacheHandler(_request, h) {
...
export { cacheTestIneligibleItems, cacheTestIsoCodes }
