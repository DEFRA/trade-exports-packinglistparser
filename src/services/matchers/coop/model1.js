/**
 * Co-op Model 1 matcher
 *
 * Detects whether a provided Excel-converted packing list matches
 * the Co-op Model 1 format by checking the establishment number and
 * header row patterns.
 */
...
/**
 * Check whether the provided packing list matches Co-op Model 1.
...
export function matches(packingList, filename) {
  try {
    ...
    logger.error(formatError(err), 'Error in Co-op 1 matcher')
