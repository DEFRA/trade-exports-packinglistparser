/**
 * CDS Excel parser - Model 3
 * @module parsers/cds/model3
 */
...
/**
 * Parse the provided packing list JSON for CDS model 3.
...
function parse(packingListJson) {
  try {
    ...
    const establishmentNumber = findMatch(
      modelHeaders.CDS3.establishmentNumber.regex,
      packingListJson[sheets[0]]
    )

    const headerTitles = Object.values(modelHeaders.CDS3.regex)
    ...
    logger.error(formatError(err), 'Error in parse() for CDS Model 3')
