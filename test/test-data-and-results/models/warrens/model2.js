    ...
    'Customer Order': [
      {
        ...
        K: 'Item Net Weight (kgs)',
        L: 'Item value',
        M: 'Nature of Product (Chilled /Ambient/ Frozen)', // Matches /Nature of Product/i
        N: 'Type of Treatment (Processed/ Unprocessed/ Raw)', // Matches /Type of Treatment/i
        O: 'NIRMS / Non NIRMS', // Matches /NIRMS \/ Non NIRMS/i
        P: 'NIRMS Despatch No.',
        Q: 'Secondary Qty',
        R: 'Cert Type Req',
        S: 'Cert Number'
    ...
    items: [
      {
        ...
        description: 'BROWN CIABATTA 200g U',
